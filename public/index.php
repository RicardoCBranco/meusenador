...
<svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="450px" height="460px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
  ...
  <g>
    ...
    </a><a xlink:href="senadores/?uf=RO">
            ...
            <div class="modal" id="modalSobre">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <!-- Corpo -->
                        <div class="modal-body text-justify" id="modal">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <!-- Corpo -->
                        <div class="modal-body text-justify" id="modal">
                        <p>Dados abertos governamentais são dados das informações do setor público que podem ser
                        livremente utilizados, reutilizados e redistribuídos em aplicações digitais desenvolvidas
                        para sociedade.
                        </p>
                        <p>Reutilizamos os dados fornecidos pelo Portal da 
                            Transparência do Senador Federal. 
                        </p>
                        <p>Link: <a href="http://www.senado.gov.br/transparencia" target="__blank">Portal da Transparência</a></p>
                        </div>
                        <!-- Rodapé -->
                        <div class="modal-footer">
                            <button class="btn btn-success" data-dismiss="modal">Close</button>
